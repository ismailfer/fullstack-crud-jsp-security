		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<fieldset class="form-group">
					...
					<form:input path="targetDate" type="text" value="${targetDateFormatted}" class="form-control" required="required" />
					<form:errors path="targetDate" cssClass="text-warning" />
				</fieldset> 			

				<fieldset class="form-group">
					<form:label path="isDone">Is Done</form:label>
					<form:checkbox path="isDone" value="element" class="form-control" />
				</fieldset> 
